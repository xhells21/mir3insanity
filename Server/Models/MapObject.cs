...
namespace Server.Models
{
    public abstract class MapObject
    {
                    ...
                    case PoisonType.Infection:
                        ...
                        else
                        {
                            ...
                            for (int x = 0; x < poison.Owner.Stats[Stat.Rebirth]; x++)
                                rebirthmultiplier += 0.5F;

                            damage = (int)(damage * rebirthmultiplier);
                        }
        ...
        public virtual int Attacked(MapObject attacker, int power, Element elemnet, bool canReflect = true, bool ignoreShield = false, bool canCrit = true, bool canStruck = true, bool forceCrit = false) { return 0; }
