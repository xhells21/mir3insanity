                ...
                else
                {
                    ...
                    switch (drop.Item.ItemType)
                    {
                        ...
                        case ItemType.Amulet:
                            itemrate *= 1M + owner.Stats[Stat.BaseAmuletDropRate] / 100M;
                            break;
                        case ItemType.Meat:
                            itemrate *= 1M + owner.Stats[Stat.BaseMeatDropRate] / 100M;
                            break;
                        case ItemType.Ore:
                        ...
                        case ItemType.Consumable:
                            itemrate *= 1M + owner.Stats[Stat.BasePotionDropRate] / 100M;
                            break;
