...
namespace Server.Models.Monsters
{
    public class TreeMonster : MonsterObject
    {
        ...
        public override int Attacked(MapObject ob, int power, Element element, bool canReflect = true, bool ignoreShield = false, bool canCrit = true, bool canStruck = true, bool forceCrit = false)
        {
