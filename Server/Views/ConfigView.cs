...
namespace Server.Views
{
    public partial class ConfigView : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void LoadSettings()
        {
            ...
            AccountCreationHuntGoldEdit.EditValue = Config.AccountCreationHuntGold;
            ...
            NecklaceDropRateEdit.EditValue = Config.NecklaceDropRate;
            BraceletDropRateEdit.EditValue = Config.BraceletDropRate;
            RingDropRateEdit.EditValue = Config.RingDropRate;
            ShoesDropRateEdit.EditValue = Config.ShoesDropRate;
            AmuletDropRateEdit.EditValue = Config.AmuletDropRate;
            MeatDropRateEdit.EditValue = Config.MeatDropRate;
            OreDropRateEdit.EditValue = Config.OreDropRate;
            BookDropRateEdit.EditValue = Config.BookDropRate;
            ScrollDropRateEdit.EditValue = Config.ScrollDropRate;
            PotionDropRateEdit.EditValue = Config.PotionDropRate;
            ShieldDropRateEdit.EditValue = Config.ShieldDropRate;
        }
        public void SaveSettings()
        {
            ...
            Config.AccountCreationHuntGold = (int)AccountCreationHuntGoldEdit.EditValue;
            ...
            Config.NecklaceDropRate = (int)NecklaceDropRateEdit.EditValue;
            Config.BraceletDropRate = (int)BraceletDropRateEdit.EditValue;
            Config.RingDropRate = (int)RingDropRateEdit.EditValue;
            Config.ShoesDropRate = (int)ShoesDropRateEdit.EditValue;
            Config.AmuletDropRate = (int)AmuletDropRateEdit.EditValue;
            Config.MeatDropRate = (int)MeatDropRateEdit.EditValue;
            Config.OreDropRate = (int)OreDropRateEdit.EditValue;
            Config.BookDropRate = (int)BookDropRateEdit.EditValue;
            Config.ScrollDropRate = (int)ScrollDropRateEdit.EditValue;
            Config.PotionDropRate = (int)PotionDropRateEdit.EditValue;
            Config.ShieldDropRate = (int)ShieldDropRateEdit.EditValue;
