...
namespace Server.Envir
{
    ...
    public static class Config
    {
        ...
        public static int AccountCreationHuntGold { get; set; } = 0;
        ...
        public static int NecklaceDropRate { get; set; } = 0;
        public static int BraceletDropRate { get; set; } = 0;
        public static int RingDropRate { get; set; } = 0;
        public static int ShoesDropRate { get; set; } = 0;
        public static int AmuletDropRate { get; set; } = 0;
        public static int MeatDropRate { get; set; } = 0;
        public static int OreDropRate { get; set; } = 0;
        public static int BookDropRate { get; set; } = 0;
        public static int ScrollDropRate { get; set; } = 0;
        public static int PotionDropRate { get; set; } = 0;
        public static int ShieldDropRate { get; set; } = 0;
